...
<?php $this->load->view('links/links'); ?>
  <!-- InstanceBeginEditable name="EditingPane" -->
    <div class="editingwindow">
      <div class="price">
        <div align="center">Movie Genre Images</div>
      </div>
    ...
    <div class="editingwindow">
      <hr />
      <div class="price">
        <div align="center">Add Data For Misc. Movies<br />
        <span class="tiny">The API could not find data for these titles. Edit the title correctly and click search. The description and image will self populate from the API with the complete data once the movie is found. Then click submit.</span></div>
      </div>
...
<script src="<?php echo base_url(); ?>js/iptvmovies.js"></script>
...
<script type="text/javascript">
      ...
      if($_SESSION['username']=='FissNew')
        echo "var src='http://appy.zone/iptv/images/movies/'+ime+'.png';";
      else
        echo "var src='http://appy.zone/".$_SESSION['username']."/iptv/images/movies/'+ime+'.png';";
      ?>
      $(".img3").attr("src", src);    
  }); 
</script>
