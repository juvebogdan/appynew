...
<p>&nbsp;</p>
    ...
    <div class="editingwindow">
      ...
      <span class="tiny">The home screen is a place for fast access to user generated lists with a maximum of 5 Rows</span></p>
    <div id='content'>
      <div class="trueHalf" id='build1'>
        <div align="center">
          <p>Row 1: 
            <select name="select1" id="select1">
              <option value='1' <?php $x=(isset($actions[0])&&trim($actions[0])=="1") ? "selected" : "";echo " " . $x; ?>>Most Used Apps</option>
              <option value='2' <?php $x=(isset($actions[0])&&trim($actions[0])=="2") ? "selected" : "";echo " " . $x; ?>>Most Used Kodi Builds</option>
        ...
        <div align="center">
          <p>Row 2: 
            <select name="select2" id="select2">
              <option value='1' <?php $x=(isset($actions[1])&&trim($actions[1])=="1") ? "selected" : "";echo " " . $x; ?>>Most Used Apps</option>
              <option value='2' <?php $x=(isset($actions[1])&&trim($actions[1])=="2") ? "selected" : "";echo " " . $x; ?>>Most Used Kodi Builds</option>
        ...
        <div align="center">
          <p>Row 3: 
            <select name="select3" id="select3">
              <option value='1' <?php $x=(isset($actions[2])&&trim($actions[2])=="1") ? "selected" : "";echo " " . $x; ?>>Most Used Apps</option>
              <option value='2' <?php $x=(isset($actions[2])&&trim($actions[2])=="2") ? "selected" : "";echo " " . $x; ?>>Most Used Kodi Builds</option>
              <option value='3' <?php $x=(isset($actions[2])&&trim($actions[2])=="3") ? "selected" : "";echo " " . $x; ?>>Most Used IPTV</option>
              <option value='4' <?php $x=(isset($actions[2])&&trim($actions[2])=="4") ? "selected" : "";echo " " . $x; ?>>Favourites</option>
            </select>
          </p>
          <p>
          Title: 
        ...
        <div align="center">
          <p>Row 4: 
            <select name="select4" id="select4">
              <option value='1' <?php $x=(isset($actions[3])&&trim($actions[3])=="1") ? "selected" : "";echo " " . $x; ?>>Most Used Apps</option>
              <option value='2' <?php $x=(isset($actions[3])&&trim($actions[3])=="2") ? "selected" : "";echo " " . $x; ?>>Most Used Kodi Builds</option>
              <option value='3' <?php $x=(isset($actions[3])&&trim($actions[3])=="3") ? "selected" : "";echo " " . $x; ?>>Most Used IPTV</option>
              <option value='4' <?php $x=(isset($actions[3])&&trim($actions[3])=="4") ? "selected" : "";echo " " . $x; ?>>Favourites</option>
            </select>
          </p>
          <p>
          Title: 
        ...
        <div align="center">
          <p>Row 5: 
            <select name="select5" id="select5">
              <option value='1' <?php $x=(isset($actions[4])&&trim($actions[4])=="1") ? "selected" : "";echo " " . $x; ?>>Most Used Apps</option>
              <option value='2' <?php $x=(isset($actions[4])&&trim($actions[4])=="2") ? "selected" : "";echo " " . $x; ?>>Most Used Kodi Builds</option>
              <option value='3' <?php $x=(isset($actions[4])&&trim($actions[4])=="3") ? "selected" : "";echo " " . $x; ?>>Most Used IPTV</option>
              <option value='4' <?php $x=(isset($actions[4])&&trim($actions[4])=="4") ? "selected" : "";echo " " . $x; ?>>Favourites</option>
            </select>
          </p>
          <p>
          Title: 
...
$(document).ready(function(){
  ...
  {     
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>appy/homeupload', 
        type: "POST",            
        data: formData,
        contentType: false,       
        cache: false,             
